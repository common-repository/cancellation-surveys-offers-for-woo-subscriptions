...
class FileManager {
	...
	public function includeTemplate( $__template, array $__variables = array() ) {
		...
		if ( $__template ) {
			...
			do_action( 'cancellation_offers/template/before_render', $__template, $__variables );
			include( $__template );
			do_action( 'cancellation_offers/template/after_render', $__template, $__variables );
		}
	}
	...
	public function locateTemplate( $template ) {
		...
		return apply_filters( 'cancellation_offers/template/location', $file, $template );
	}
